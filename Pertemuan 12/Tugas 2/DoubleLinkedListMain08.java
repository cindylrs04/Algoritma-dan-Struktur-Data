...
public class DoubleLinkedListMain08 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DoubleLinkedListMain08 listFilm = new DoubleLinkedListMain08();
        ...
        do {
            ...
            switch (pilih) {
                ...
                case 8:
                    ...
                    Film08 found = listFilm.findFilm(idKey);
    ...
    public void add(int id, String judul, double rate, int idx) {
